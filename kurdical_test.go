...
func TestKurdishToGregorian(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Leap year, valid day 30 in month 12",
			input: KurdishDate{
				Year:    2724, // 2724 - 1321 = 1403, isSolarHijriLeap(1403) = true
				Month:   12,
				Day:     30,
				Dialect: Sorani,
				Epoch:   MedianKingdom,
		...
		{
			name: "Leap year, invalid day 31 in month 12",
			input: KurdishDate{
				Year:    2724,
				Month:   12,
				Day:     31,
